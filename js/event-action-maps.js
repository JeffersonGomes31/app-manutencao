...
(function registrarMapasDeAcoesDaInterface() {
  ...
  const acoesClique = {
    ...
    "selecionar-aba-fila-ativas": () => executarAcao("selecionarAbaFilaPainel", "ATIVAS"),
    "selecionar-aba-fila-encerradas": () => executarAcao("selecionarAbaFilaPainel", "ENCERRADAS"),
    "selecionar-aba-chamados-ativas": () => executarAcao("selecionarAbaChamados", "ATIVAS"),
    "selecionar-aba-chamados-encerradas": () => executarAcao("selecionarAbaChamados", "ENCERRADAS"),
